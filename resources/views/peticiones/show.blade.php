                    ...
                    <div class="card my-3">
                        <div class="card-body d-flex flex-column flex-sm-row position-relative">
                            ...
                            <div class="d-flex flex-column w-100">
                                ...
                                <span class="text-muted text-gray w-50"><p><b>Únete a {{$content->firmantes}} personas que ya han firmado esta petición</b></p></span>
                                @if($errors->any())
                        ...
                        @if(auth::check())
                            <form method="POST" action="{{route('peticiones.firmar',$content)}}"
